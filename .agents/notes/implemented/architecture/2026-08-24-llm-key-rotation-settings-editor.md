...
> Partially superseded by [Key rotation overlays existing provider routes](2026-08-24-llm-key-rotation-provider-key-overlay.md): the route-ownership, standalone-page, and collision-refusal decisions below are replaced; the section install, wire read, trust model, and persistence carry forward.
