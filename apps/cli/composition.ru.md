...
# Базовая композиция DSH

Патч бандла dsh-base применяется первым в каждом профиле; поверх него свои патчи накладывают бандлы режимов (dsh-web-app, dsh-headless) и пользовательский слой профиля.
...
Исходная конфигурация: [`packages/bundle/base/cordis.patch.yml`](../../packages/bundle/base/cordis.patch.yml).
