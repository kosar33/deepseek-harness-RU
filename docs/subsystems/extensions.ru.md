...
[English](extensions.md) | [中文](extensions.zh.md) | Русский

Подсистема расширений позволяет агенту объявлять версионированные пакеты Cordis, запускать их хостовые и браузерные половины и запрашивать одобренные метаданные рантайма, прежде чем писать код. Жизненным циклом пакетов и поведением песочницы владеет группа пакетов [`packages/extensions`](../../packages/extensions/README.md).
