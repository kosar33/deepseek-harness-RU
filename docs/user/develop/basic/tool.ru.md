...
Этот туториал добавляет инструмент `greet` в веб-интерфейс. Сначала завершите [«Ваш первый плагин»](./index.ru.md) и сохраните его каталог `scratch-plugin`.
...
- [Справочник по созданию инструментов](../../../cookbook/adding-a-tool.md) — вложенные схемы, канонические значения, фоновая работа, policy-хууки, Code Mode и UI-карточки.
