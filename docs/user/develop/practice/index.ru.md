...
У этой страницы две части: справочник по концепции трёхролевого шаблона возможностей, за которым следует продвинутый туториал, строящий одну возможность. Сначала завершите [базовый путь плагинов](../basic/index.ru.md) и [туториал по сервисам](../framework/service.ru.md).
...
- Service Provider могут улучшать производительность и безопасность независимо.
- Consumer могут менять способ представления возможности модели.
