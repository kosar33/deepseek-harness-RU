...
# Композиция приложения автоматизации ACP

Демо ACP открывает программным клиентам свежие сессии агентов с базовым промптом поверх JSON-RPC stdio — без логгера stdout, пользовательского интерфейса и заранее созданного агента.
...
Исходная конфигурация: [`examples/acp-agent/cordis.yml`](cordis.yml).
