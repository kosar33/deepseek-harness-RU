 ...
 * `zh`/`en`/`ru` dictionaries carry identical key sets, so no direction can
 * leave a key unresolved; the residual case points at English rather than
 * zh because a browser naming none of the shipped languages is the reader
 * least likely to read Chinese.
 */
