...
export const zh = {
  ...
  'access.mode.workspace-write': 'Workspace Write',
  ...
  'message.keyRotatedUntil': '限流至 {time}',
  ...
  'read.windowed': '显示 {shown} / {total} 行',
  'read.collapseAria': '收起内容',
  'read.expandAria': '展开其余 {n} 行',
  'read.expandRest': '… 其余 {n} 行',
  'search.summaryCapped': '显示 {shown} / 共 {total}',
  'search.summaryPaths': '{count} 个路径',
  'search.summaryMatches': '{count} 处匹配 · {files} 个文件',
  'search.empty': '无结果',
  'search.collapseAria': '收起结果',
  'search.expandAria': '展开其余 {n} 行结果',
  'search.expandRest': '… 其余 {n} 行',
  'web.searchEmpty': '未找到结果',
  'web.sourcesTruncated': '来源列表已截断',
  'web.fetchTruncated': '内容已截断',
...
export const en = {
  ...
  'message.keyRotatedUntil': 'rate-limited until {time}',
  ...
  'read.windowed': 'Showing {shown} / {total} lines',
  'read.collapseAria': 'Collapse contents',
  'read.expandAria': 'Expand the remaining {n} lines',
  'read.expandRest': '… {n} more lines',
  'search.summaryCapped': 'Showing {shown} / {total} total',
  'search.summaryPaths': '{count} paths',
  'search.summaryMatches': '{count} matches · {files} files',
  ...
  'web.searchEmpty': 'No results found',
  'web.sourcesTruncated': 'Source list truncated',
  'web.fetchTruncated': 'Content truncated',
...
export const ru = {
  ...
  'placeholder.parentOffline': 'Родительская сессия отключена; отправка недоступна, но текущий запуск можно остановить',
  ...
  'placeholder.steerQueue': 'Cmd/Ctrl+Enter — внеочередная отправка всех сообщений из очереди',
  'input.accessMode': 'Режим доступа, текущий: {name}',
  'image.dropTitle': 'Перетащите сюда изображения, чтобы добавить',
  ...
  'image.tooManyPixels': 'Разрешение изображения слишком высокое; сожмите его и повторите попытку',
  'image.dimensionTooLarge': 'Стороны изображения не должны превышать {size}px; уменьшите масштаб и повторите попытку',
  'image.modelUnsupported': 'Текущая модель не поддерживает изображения; выберите модель с поддержкой изображений',
  'image.subagentUnsupported': 'Сессии подагентов пока не поддерживают изображения',
  ...
  'settings.enter.title': 'Поведение Enter при занятом агенте',
  'settings.enter.description': 'Только пока агент занят; Cmd/Ctrl+Enter использует другой вариант',
  'settings.enter.queue': 'Поставить в очередь',
  'settings.enter.steer': 'Отправить вне очереди',
  'access.mode.read-only': 'Только чтение',
  'access.mode.workspace-write': 'Запись в рабочей области',
  'access.mode.full-access': 'Полный доступ',
  'access.confirm.title': 'Включить полный доступ?',
  'access.confirm.description': 'Полный доступ уменьшает число подтверждений и позволяет агенту напрямую выполнять больше действий, включая чувствительные операции, изменение файлов и внешние команды. Используйте его, только если доверяете текущей задаче.',
  ...
  'details.empty': 'Нажмите строку инструмента в потоке сообщений, чтобы открыть подробности',
  'details.notInWindow': 'Вызов за пределами текущего окна',
  'details.input': 'Ввод',
  ...
  'todo.progress.pending': '{pending} ожидают',
  ...
  'message.contextRecall': 'Контекст из другой сессии',
  ...
  'message.compaction.completed': 'Сжато {items} записей истории (~{tokens} tokens)',
  ...
  'message.keyRotatedUntil': 'лимит до {time}',
  ...
  'message.retry.active': 'Повторение запроса к модели',
  'message.retry.cancelled': 'Повторение запроса отменено',
  ...
  'message.maxTokens.hint': 'Ответ был обрезан; уже выведенный текст сохранился в переписке. Отправьте «продолжить», чтобы модель продолжила.',
  ...
  'approval.waiting': 'Ожидает одобрения',
  'approval.detail.aria': 'Подробности одобрения',
  ...
  'queue.steer.unavailable': 'Внеочередная отправка доступна только во время работы агента',
  ...
  'queue.steerFailed': 'Не удалось отправить вне очереди. Повторите попытку.',
  ...
  'read.windowed': 'Показано {shown} из {total}',
  'read.collapseAria': 'Свернуть содержимое',
  'read.expandAria': 'Развернуть остальные строки ({n})',
  'read.expandRest': '… ещё {n}',
  'search.summaryCapped': 'Показано {shown} / всего {total}',
  'search.summaryPaths': 'путей: {count}',
  'search.summaryMatches': 'совпадений: {count} · файлов: {files}',
  'search.empty': 'Нет результатов',
  'search.collapseAria': 'Свернуть результаты',
  'search.expandAria': 'Развернуть остальные строки результатов ({n})',
  'search.expandRest': '… ещё {n}',
  'web.searchEmpty': 'Ничего не найдено',
  'web.sourcesTruncated': 'Список источников усечён',
  'web.fetchTruncated': 'Содержимое усечено',
  'json.truncated': '… усечено, всего символов: {total}',
  'clock.md': '{d}.{m}',
  'clock.ymd': '{d}.{m}.{y}',
} satisfies Record<ConversationKey, string>
