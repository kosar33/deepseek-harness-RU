...
export const ru = {
  nav: 'Плагины',
  title: 'Плагины',
  intro: 'Просмотр и настройка плагинов, установленных в этом развёртывании.',
  ...
  saveFailed: 'Развёртывание отклонило эти значения; они оставлены в полях для исправления.',
  ...
  bashTimeoutMsHint: 'Сколько времени может выполняться одна команда до принудительного завершения.',
  bashMaxOutputBytes: 'Лимит вывода на поток (байты)',
  bashMaxOutputBytesHint: 'Излишек вывода сохраняется во временный файл, а не теряется.',
  ...
  agentLoopMaxParallelHint: 'Максимум параллельных вызовов, выполняемых одновременно в пределах одного шага.',
  ...
  webSearchMaxUsesHint: 'Сколько раз один запрос может выполнить поиск перед ответом.',
