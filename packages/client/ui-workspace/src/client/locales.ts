...
export const ru = {
  ...
  'conflict.named': 'Рабочая область с названием «{name}» уже существует.',
  ...
  'delete.desc': 'Рабочая область «{name}» будет удалена из списка. Папка и журналы сессий сохранятся; её сессии появятся в разделе «Без группы».',
  ...
  'status.subagentsRunning.one': '{n} подагент работает',
  'status.subagentsRunning.other': '{n} подагентов работает',
  'status.idle': 'Бездействует',
  'status.waitingApproval': 'Ожидает одобрения',
  'status.planReview': 'План ожидает проверки',
  'status.waitingAnswer': 'Ожидает ответа',
  'status.completed': 'Завершено',
  'hover.created': 'Создана {time}',
