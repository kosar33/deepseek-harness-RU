...
export const SERVICE_WALK_EXEMPTIONS: Record<string, string> = {
  ...
  llmApiKeyOverride: 'optional service: dsh-llm-key-rotation provides it when mounted; consumers read it through strict ctx.get — packages/llm/llm-key-rotation/README.md owns the contract',
