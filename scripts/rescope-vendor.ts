...
const EXACT_EDITS: readonly ExactEdit[] = [
  ...
  {
    // Upstream's knip cleanup removed the packages/util/home workspace entry
    // together with its stale @cordisjs/plugin-logger-console exclusion, so
    // the former knip-logger-console exact edit has nothing left to match.
    id: 'knip-bundle-base',
    file: 'knip.json',
