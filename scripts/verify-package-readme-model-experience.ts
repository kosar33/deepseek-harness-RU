...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-settings-key-rotation': { kind: 'none', reason: 'Browser-side settings block over credentials and rotation profiles; registers nothing model-facing.' },
